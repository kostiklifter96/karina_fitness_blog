        ...
        skills: [
            {
                id: 8,
                title: "9 тренировок ",
                description: `- каждый месяц новые тренировки
                - 3 тренировки в неделю по 30 минут
                - без дополнительного инвентаря
                - для любого возраста
                - для разной физ.подготовки`,
                img: "icons/skills/gym.svg",
            },
            {
                id: 9,
                title: "Расчет кБЖУ",
                description: `Вам будет доступна информация о том:
                    - как правильно рассчитать свою суточную калорийность
                    - каким должен быть дефицит калорий
                    - как рассчитать индивидуальное`,
                img: "icons/skills/21day.svg",
            },
            {
                id: 10,
                title: "План питания",
                description: `- готовое меню на 21 день с рассчитанным кБЖУ
                 - плавный дефицит калорий
                 - сбалансированное разнообразное меню
                 - "метод тарелки" для тех, кто не хочет считать калории
                 `,
            ...
            },
            {
                id: 11,
                title: "Общий чат",
                description: `У всех участников фитнес-проекта Naumova Team будет доступ к общему чату:
                - для общения
                - для поддержки
                - мотивации
        ...
        advantages: [
            {
                id: 1,
                description:
                    "Naumova Team – не марафон на 1000 ккал, а возможность избавиться от мифов и достичь целей в фитнесе",
            },
            {
                id: 2,
                description:
